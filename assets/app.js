(function () {
  ...
  var MODULE_META = {
    ...
    reading: { title: '小说阅读管理', desc: '记录小说名称、主要内容和可转化为账号素材的阅读线索。' },
    ...
    media: { title: '主流媒体', desc: '收藏和拆解人民日报、新华社、解放军报等主流媒体稿件。' },
  ...
  var sampleData = {
    ...
    writingDailyUpdates: [
      { id: 'writing-20260723-01', source: '国务院公报', title: '国务院关于修改和废止部分行政法规的决定', date: '2026-07-23', summary: '文种类型：决定。适合学习规范性文件标题、条款式正文和政策依据表达。', url: 'https://www.gov.cn/gongbao/' },
      { id: 'writing-20260722-01', source: '党建网', title: '以高质量党建引领基层治理提质增效', date: '2026-07-22', summary: '文种类型：党建评论。适合积累“党建引领、协同治理、闭环落实”等体制内表达。', url: 'https://www.dangjian.cn/' },
      { id: 'writing-20260721-01', source: '求是网', title: '坚持系统观念推动改革任务落地见效', date: '2026-07-21', summary: '文种类型：理论文章。可提炼总分结构、政治性表述和段落过渡句。', url: 'https://www.qstheory.cn/' },
      { id: 'writing-20260720-01', source: '中国政府网', title: '关于进一步做好政务服务事项标准化工作的通知', date: '2026-07-20', summary: '文种类型：通知。重点参考“工作目标、重点任务、保障措施”的结构安排。', url: 'https://www.gov.cn/zhengce/' }
    ],
    writingFavorites: [],
    travel: [
      {
    ...
    media: [
      { id: uid(), source: '人民日报', title: '以进一步全面深化改革开辟中国式现代化广阔前景', date: '2026-07-22', summary: '文章深入阐述党的二十届三中全会精神，强调要以改革创新为根本动力，推动高质量发展，加快建设社会主义现代化强国。', url: 'http://paper.people.com.cn/rmrb/' },
      { id: uid(), source: '人民日报', title: '凝聚起推进中国式现代化的磅礴力量', date: '2026-07-21', summary: '评论员文章指出，面对复杂严峻的国际形势和艰巨繁重的国内改革发展稳定任务，必须坚持和加强党的全面领导，凝聚全党全国各族人民的智慧和力量。', url: 'http://paper.people.com.cn/rmrb/' },
      { id: uid(), source: '解放军报', title: '锻造高素质新型军事人才方阵', date: '2026-07-22', summary: '报道我军深入推进军事人才培养体系改革，着力培养联合作战指挥人才、新型作战力量人才和高层次科技创新人才，为强军事业提供坚强人才支撑。', url: 'http://www.81.cn/' },
      { id: uid(), source: '解放军报', title: '全面加强军事治理 提高国防和军队现代化水平', date: '2026-07-20', summary: '文章强调要按照国防和军队现代化新"三步走"战略安排，全面加强军事治理，确保如期实现建军一百年奋斗目标。', url: 'http://www.81.cn/' },
      { id: uid(), source: '求是网', title: '坚持以人民为中心的发展思想', date: '2026-07-21', summary: '理论文章系统论述了以人民为中心发展思想的理论内涵和实践要求，强调人民是历史的创造者，是决定党和国家前途命运的根本力量。', url: 'http://www.qstheory.cn/' },
      { id: uid(), source: '新华网', title: '时政新闻：中共中央政治局召开会议分析研究当前经济形势', date: '2026-07-22', summary: '会议指出，当前经济运行总体平稳、稳中有进，高质量发展扎实推进，但也要清醒看到面临的困难和挑战。', url: 'http://www.news.cn/politics/' }
    ],
    mediaDailyUpdates: [
      { id: 'media-20260723-01', source: '人民日报', title: '坚定不移推动高质量发展取得新成效', date: '2026-07-23', summary: '聚焦高质量发展、改革创新和民生保障，适合作为新闻稿导语和评论标题拆解素材。', url: 'http://paper.people.com.cn/rmrb/' },
      { id: 'media-20260723-02', source: '新华社', title: '上半年国民经济运行稳中有进', date: '2026-07-23', summary: '围绕宏观经济数据、政策成效和下一步重点工作展开，适合学习数据型新闻稿写法。', url: 'https://www.news.cn/politics/' },
      { id: 'media-20260722-01', source: '解放军报', title: '聚力练兵备战锻造胜战本领', date: '2026-07-22', summary: '报道基层部队实战化训练情况，可参考其“事实+细节+精神内核”的报道结构。', url: 'http://www.81.cn/' },
      { id: 'media-20260721-01', source: '新华网', title: '各地扎实推进重点项目建设', date: '2026-07-21', summary: '以多地案例串联政策落地情况，适合积累综合报道中的并列式结构。', url: 'https://www.news.cn/politics/' }
    ],
    mediaFavorites: [],
    packingItems: [
  ...
  function renderSummary() {
    ...
    $('todoCount').textContent = state.todos.filter(function (t) { return !t.done; }).length;
    $('readingCount').textContent = state.novels.length;
    $('writingCount').textContent = state.writing.filter(function (w) { return !w.done; }).length;
    $('travelCount').textContent = state.travel.length;
    $('hotspotCount').textContent = state.hotspots.length;
    $('mediaCount').textContent = state.media.length;
    $('navTodos').textContent = state.todos.filter(function (t) { return !t.done; }).length;
    $('navReading').textContent = state.novels.length;
    $('navWriting').textContent = state.writing.length;
    $('navTravel').textContent = state.travel.length;
    $('navHotspot').textContent = state.hotspots.length;
    $('navMedia').textContent = state.media.length;
    if ($('navEnglish')) $('navEnglish').textContent = (state.englishDailyUpdates || []).length;
    if ($('navPhoto')) $('navPhoto').textContent = state.photoScenes ? state.photoScenes.length : 0;
  ...
  function renderTravel() {
    ...
    el.innerHTML = items.length ? items.map(function (d) {
      return '<div class="day-card">' +
        ...
        '<span>地图加载中...（高德地图需要 API Key）</span></div></div>' +
        '</div>' +
      ...
      return '<div class="photo-scene-card">' +
        ...
        ((scene.items || []).length ? (scene.items || []).map(function (item) {
          ...
          if (item.type === 'link') {
            ...
            var appScheme = item.platform === 'douyin' ? 'snssdk1128://feed' : item.platform === 'xiaohongshu' ? 'xhsdiscover://index' : item.url;
            return '<div class="photo-link-card">' +
              ...
              '<a class="photo-link-btn" href="' + esc(appScheme) + '" onclick="window.tryOpenApp &amp;&amp; window.tryOpenApp(event, \'' + esc(item.url) + '\', \'' + item.platform + '\')">' + platformIcon + ' 在' + platformLabel + 'APP打开</a>' +
  ...
  // 尝试打开抖音/小红书APP，失败则 fallback 到浏览器打开原链接
  window.tryOpenApp = function (e, url, platform) {
    e.preventDefault();
    var scheme = platform === 'douyin' ? 'snssdk1128://feed' : platform === 'xiaohongshu' ? 'xhsdiscover://index' : url;
  ...
  function openMapModal(dayId) {
    ...
    mapEl.innerHTML = '<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;color:var(--muted);font-size:15px;gap:12px">' +
      '<span style="font-size:48px">\uD83D\uDDFA\uFE0F</span>' +
      '<span>地图加载中...（高德地图需要 API Key）</span>' +
  ...
  if (sidebarToggle) {
    sidebarToggle.addEventListener('click', function () {
      ...
      if (isMobile) {
        document.body.classList.toggle('sidebar-expanded-mobile');
        localStorage.setItem(SIDEBAR_KEY, document.body.classList.contains('sidebar-expanded-mobile') ? 'expanded-mobile' : 'collapsed-mobile');
      } else {
        document.body.classList.toggle('sidebar-collapsed');
        localStorage.setItem(SIDEBAR_KEY, document.body.classList.contains('sidebar-collapsed') ? 'collapsed' : 'expanded');
      }
      var text = sidebarToggle.querySelector('.toggle-text');
      if (text) text.textContent = document.body.classList.contains('sidebar-collapsed') ? '展开导航' : '收起导航';
    });
  }
  ...
  if (savedSidebar === 'expanded-mobile') document.body.classList.add('sidebar-expanded-mobile');
  var initToggleText = document.querySelector('#sidebarToggle .toggle-text');
  if (initToggleText) initToggleText.textContent = document.body.classList.contains('sidebar-collapsed') ? '展开导航' : '收起导航';
